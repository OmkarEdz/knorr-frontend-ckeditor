      ...
      <div class="col-xl-4 pl-8 pl-md-12 pl-xl-8 row">
        ...
        <div class="video_section">
          ...
          <v-dialog v-model="openAddDialog" width="unset" content-class="vdialognew">
            <video class="video_popup" controls controlsList="nodownload" oncontextmenu="return false;" autoplay v-if="openAddDialog == true && $locale === 'en' || $locale === 'hu' || $locale === 'pl' || $locale === 'fr'">
