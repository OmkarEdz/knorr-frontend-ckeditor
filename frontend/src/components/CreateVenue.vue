  ...
  <div>
    ...
    <div class="col-xl-3 px-0 pl-8 pl-md-12 row pt-0">
        <div class="col-xl-12 right-side-block">
          ...
          <div class="mt-6"></div>
          <v-btn v-show="editMode" @click="deleteVenue()" outlined depressed tile class="mr-2 deletebutton mb-2">{{ $t("delete") }}</v-btn>
          <v-btn @click="$routerBack()" outlined depressed tile class="cancelbutton mr-2 mb-2">{{ $t("cancel") }}</v-btn>
          <v-btn @click="saveVenue()" outlined depressed tile class="savebutton mb-2">{{ $t("save") }}</v-btn>
        </div>
        <Contact />
      </div>
