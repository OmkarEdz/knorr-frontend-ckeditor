<template>
  <div class="col-xl-12 right-side-block">
        <h4 class="text-uppercase">{{ $t("contact") }}</h4>
        <div class="right-side divider"></div>
        <div class="mt-6"></div>
        <span class="font-blue font-bigger font-weight-bold">RailServices</span><br>
        <span class="font-blue">Knorr-Bremse Systeme für Schienenfahrzeuge GmbH</span><br>
        <span class="font-blue">Trainingsakademie Germany (R/SGF3)</span><br>
        <span class="font-blue">+49 (0) 30 9392-2223</span><br>
        <span class="font-blue">{{ $t("contact_available") }} 07:00 – 17:00 {{ $t("oclock") }}.</span>
        <p>Georg-Knorr Straße 4<br>
